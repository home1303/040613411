    ...
    <div class="container">
      <div class="card text-center" style="width: auto;">
        <div class="card-body shadow-lg">
                ...
                <h1 class="text-center p-md-3">Domain</h1>
                <hr>       
          ...
          <table class="table table-bordered">
            <thead class="table table-dark">
                <tr>
                  <th class="table-dark text-center align-middle">Extensions (TLD)</th>
                    <th class="text-center align-middle">จดโดเมน</th>
                    <th class="text-center align-middle">ต่ออายุโดเมน</th>
                    <th class="text-center align-middle">ย้ายโดเมน</th>
            ...
            <tbody>
                <tr>
                  <th class="table-secondary text-center align-middle"><?php echo $item['pack_domain_name'] ?></th>
                  <td class="text-center align-middle"><?php echo $item['pack_domain_price'] ?> บาท</td>
                  <td class="text-center align-middle"><?php echo $item['pack_domain_price_2'] ?> บาท</td>
                  <td class="text-center align-middle"><?php echo $item['pack_domain_price_3'] ?> บาท</td>   
                  <td class="text-center align-middle"><a href="order_domain.php?item=<?= $item['pack_domain_id']; ?>" class="btn btn-block btn-success">Select</a></td>     
                </tr>               
                <?php } 
                    } ?> 
              </tbody>
