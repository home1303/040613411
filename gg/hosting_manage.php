  ...
  <div class="container">
    <div class="card text-center" style="width: auto;">
      <div class="card-body shadow-lg">
        <!----------------------------Dedicated------------------------------------------->
        <h1 class="text-uppercase text-center mb-3">Hosting Manage <p class="fs-5">จัดการโฮสของคุณ </p></h1>
        <table class="table table-bordered">
          ...
          <?php
            ...
            $result1 = $conn->query("SELECT * FROM oder_item_hosting JOIN package_plan_hosting ON oder_item_hosting.oder_package_id = package_plan_hosting.pack_hosting_id WHERE oder_email = '$user_email'");
            if ($result1 !== false) {
          ...
          ?>
              <tr>
                ...
                <td class="text-center align-middle">ติดตั้งเครื่องเซิฟเวอร์ Package <?php echo $item1['oder_package_id'] ?><div class="text-muted" style="font-size:0.7rem"><?php echo $item1['hosting_pack_domains'] ?> Domains | <?php echo $item1['hosting_pack_space'] ?> Space | <?php echo $item1['hosting_pack_transfer'] ?> transfer | <?php echo $item1['hosting_pack_database'] ?> MySQL</div></td>
                ...
                <td class="text-center align-middle"><a href="hosting_manage_data.php?item=<?= $item1['oder_id']; ?>" class="btn btn-outline-primary <?php echo $role_button ?>">จัดการ</button></a></td>
            </tr>
            <?php } 
             } ?>
          </tbody>
        </table>
        <div class="text-muted" style="font-size:1rem"><?php echo 'คุณมีโฮส '.$result1->rowCount()." ตัว"; ?></div>
      </div>
    </div>
  </div>
