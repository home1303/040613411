...
<?php 
    ...
    if (isset($_POST['submit'])) {
      ...
      $oder_package_type = $data['vps_pack_name'];
...
?>
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="text" style='color:#ffffff' >VPS AUTO Server</span>
    </div>
                  ...
                  <div class="card-deck">
                    <div class="card text-center" style="height: 410px;">
                      <div class="card-body shadow-sm">
                        ...
                        <h5 class="card-title fw-bold"><?= $data['vps_pack_name']; ?> #<?= $data['pack_vps_id']; ?></h5>
                        <div class="p-4">
                          <p class="card-text h5" style='color:rgba(165, 165, 165, 0.842)'><i class="fa-solid fa-microchip"></i> <?= $data['vps_pack_core']; ?> vCPU</p>
                          <p class="card-text h5" style='color:rgba(165, 165, 165, 0.842)'><i class="fa-solid fa-memory"></i> RAM <?= $data['vps_pack_memory']; ?> GB</p>
                          <p class="card-text h5" style='color:rgba(165, 165, 165, 0.842)'><i class="fa-solid fa-hard-drive"></i> SSD <?= $data['vps_pack_storage']; ?> GB</p>
                        ...
                        <div class="p-2 mb-1">
                          <p class="card-text h4 fw-bold"><?= number_format( $data['vps_pack_price'] , 2 ) ?> ฿</p>
                          <p class="card-text text-muted"><?= number_format( $data['vps_pack_price_d'] , 2 ) ?>฿/day | <?= number_format( $data['vps_pack_price_y'] , 2 ) ?>฿/yearly</p>
                        </div>
              ...
              <form action="" method="post" enctype="multipart/form-data">
                <div class="col">
                  <div class="card-deck">
                    <div class="card text-center">
                      <div class="card-body shadow-sm">
                        <h5 class="card-title fw-bold"><span class="badge bg-primary rounded-pill" style="width: 130px; height: auto;" value="<?= $data['vps_pack_name']; ?>"><?= $data['vps_pack_name']; ?> </span>
                        <span class="badge bg-primary rounded-pill" style="width: 75px; height: auto;" value="<?= $data['pack_vps_id']; ?>">#<?= $data['pack_vps_id']; ?> </span></h5>
                          ...
                          <div class="form-floating m-3">
                            <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="select_rent">
                              <option value="<?= $data['vps_pack_price']; ?>|1|Monthly"><?= number_format( $data['vps_pack_price'], 2 ) ?>฿ / 1 เดือน</option>
                              <option value="<?= $data['vps_pack_price_d']; ?>|1|Daily"><?= number_format( $data['vps_pack_price_d'] , 2 ) ?>฿ / 1 วัน</option>
                              <option value="<?= $data['vps_pack_price_y']; ?>|1|Yearly"><?= number_format( $data['vps_pack_price_y'] , 2 ) ?>฿ / 1 ปี</option>
                            </select>
                        ...
                        <a href="oder_vps.php" class="btn btn-danger">ยกเลิก</a>
                      </div>
                    </div>
                  </div>
                </div>
