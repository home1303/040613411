      ...
      <div class="card-body shadow-lg">
        ...
        <div class="m-5">
          ...
          <table class="table table-bordered">
            ...
            <tbody>
            <?php
              $result = $conn->query("SELECT * FROM oder_item");
              if ($result !== false) {
              while($item = $result->fetch()) {
            ?>
              <tr>
                <td><?php echo $item['oder_ip'] ?></td>
                <td><?php echo $item['oder_package_type'] ?></td>
                <td><?php echo $item['oder_name_server'] ?></td>
                <td><?php echo $item['oder_password_server'] ?></td>
                <td><?php echo $item['oder_status'] ?></td>
                <td><?php echo $item['oder_price'] ?></td>
                <td>
                  <a href="admin_edit_oder.php?update_id=<?= $item['oder_ip']; ?>" class="btn btn-outline-warning"><i class='bx bx-pencil'></i></a>
                  <a href="?delete_id=<?= $item['oder_ip']; ?>" class="btn btn-outline-danger"><i class='bx bx-x-circle'></i></a>
                </td>
                <?php } 
                    } ?>
              </tr>
