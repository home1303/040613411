...
<?php 
  ...
  <section class="home-section">
    <div class="home-content">
      ...
      <span class="text" style='color:#ffffff' >DDC MANAGER</span>
    </div>
    ...
    <div class="container">
      ...
      <div class="card text-center">
        <div class="card-body shadow-lg">
          <h1 class="text-uppercase text-center mb-3">DDC SERVER MANAGEMRENT ⚙️<p class="fs-5">จัดการเครื่องเซิร์ฟของคุณ </p></h1>
                        ...
                        <div class="form-floating m-3">
                          <select class="form-select" id="floatingSelect" name="select_rent" aria-label="Floating label select example">
                            ...
                            <?php
                              ...
                              $result19 = $conn->query("SELECT * FROM package_plan_ddc WHERE pack_ddc_id = $pack_display");
                              $item19 = $result19->fetch();

                            ?>
                            <option value="<?php echo $item19['ddc_pack_price'] ?>|1|Monthly"><?php echo $item19['ddc_pack_price'] ?>฿ / 1 เดือน</option>
                            <option value="<?php echo $item19['ddc_pack_price_y'] ?>|1|Yearly"><?php echo $item19['ddc_pack_price_y'] ?>฿ / 1 ปี</option>
                          </select>
